...
const resolvers = {
  ...
  Mutation: {
      signUp: async (_, {input}, {db }) => {
        ...
        //   }
         const hashPassword = bcrypt.hashSync(input.password);
         const newUser = {
             ...input,
      ...
      deleteTasklist: async (_, {id}, {db, user}) => {
        ...
        const result = await db.collection("TaskList").removeOne({_id: ObjectId(id)})
        return true
      },
      ...
      deleteToDo: async (_, {id}, {db, user}) => {
        ...
        const result = await db.collection("ToDo").removeOne({_id: ObjectId(id)})
        return true
      }
